...
class FileDropZone(QWidget):
    ...
    def _browse(self):
        path, _ = QFileDialog.getOpenFileName(
            self, "Select a file for Bezaleel", str(Path.home()),
            "All Files (*.*);;"
...
class SetupOverlay(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        layout.addWidget(_lbl("Configure Bezaleel before first boot.", 9, color=C.PRI_DIM))
        layout.addSpacing(6)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, face_path: str):
        super().__init__()
        self.setWindowTitle("Bezaleel - J.A.R.V.I.S")
    ...
    def _build_header(self) -> QWidget:
        ...
        title = QLabel("Bezaleel - J.A.R.V.I.S")
    ...
    def _build_footer(self) -> QWidget:
        ...
        lay.addStretch()
        lay.addWidget(_fl("Bezaleel Jeffrey  ·  CLASSIFIED"))
        lay.addStretch()
        lay.addWidget(_fl("© BEZALEEL INDUSTRIES", C.PRI_DIM))
        return w
    ...
    def _on_file_selected(self, path: str):
        ...
        self._file_hint.setText(f"{icon}  {p.name}  ·  {size}  ·  Tell Bezaleel what to do with it")
    ...
    def _on_setup_done(self, key: str, or_key: str, os_name: str):
        ...
        if self._overlay:
            ...
            self._overlay = None
        self._apply_state("LISTENING")
        self._log.append_log(f"SYS: Initialised. OS={os_name.upper()}. Bezaleel online.")
